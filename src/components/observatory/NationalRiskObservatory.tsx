...
export function NationalRiskObservatory() {
  ...
  return (
    <div className="space-y-8">
      {/* ── Observatory Header ── */}
      <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 rounded-3xl p-6 sm:p-8 text-white border border-slate-800 shadow-xl space-y-6">
              ...
              {filteredHotspots.map((h) => {
                ...
                return (
                  <div
                    ...
                    className={`p-4 rounded-2xl border cursor-pointer transition text-left space-y-3 ${
                      isSelected
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between text-[11px] pt-2 border-t border-slate-100 text-slate-500">
                      ...
                      <span className="text-emerald-700 font-bold hover:underline flex items-center gap-1 shrink-0">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm space-y-6 sticky top-24">
              <div className="space-y-2 border-b border-slate-100 pb-4">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono font-bold uppercase bg-slate-100 text-slate-700 px-2 py-0.5 rounded">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-emerald-950 font-medium leading-relaxed bg-emerald-50/70 p-3.5 rounded-xl border border-emerald-200">
              ...
              <div className="pt-2 border-t border-slate-100 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Link
                    ...
                    className="p-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold text-center transition flex items-center justify-center gap-1"
                  >
                  ...
                  <Link
                    ...
                    className="p-2.5 rounded-xl bg-emerald-800 hover:bg-emerald-900 text-white text-xs font-bold text-center transition flex items-center justify-center gap-1 shadow-sm"
                  >
