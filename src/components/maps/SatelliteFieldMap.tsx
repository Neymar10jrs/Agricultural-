...
export function SatelliteFieldMap() {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
      ...
      <div className="bg-slate-900 px-4 py-2.5 flex flex-wrap items-center justify-between gap-3 border-b border-slate-800 text-xs">
        ...
        <div className="flex items-center gap-1.5 bg-slate-800 p-1 rounded-xl border border-slate-700">
          ...
          >
            🌾 Field 3B Telemetry (10m Multi-spectral)
          </button>
          <button
          ...
          >
            🛰️ Live Zoom.Earth Satellite (12.7°N, 82.8°E)
          </button>
        </div>
      </div>
