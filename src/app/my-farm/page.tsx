      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {isEditing && (
          <form
            ...
            className="bg-emerald-50/70 rounded-2xl border border-emerald-200 p-5 sm:p-6 space-y-4"
          >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-base text-slate-900">Diagnostic Health Matrix</h3>
            <span className="text-xs text-slate-500">Updated today from ISRO/IMD/KVK feeds</span>
          </div>
